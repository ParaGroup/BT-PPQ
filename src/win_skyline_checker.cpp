 ...
 *  \brief Utility for testing the correctness of the SkyWin implementation
 *  
 *  This program tests the correctness of the algorithms to compute the skyline
 *  implemented in the SkyWin class.
 *  
